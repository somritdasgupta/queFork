  ...
  return (
    <div className="space-y-4">
      <RadioGroup
        ...
        className="grid grid-cols-1 md:grid-cols-2 p-0 gap-2"
      >
        <Label
          htmlFor="r-none"
          className="relative flex cursor-pointer rounded-lg border-2 p-2 hover:border-primary transition-colors
      ...
      {auth.type === "bearer" && (
        <div className="space-y-2">
          ...
          <Input
            ...
            className="border-gray-300 border-2 font-mono"
          />
        </div>
      )}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className="border-gray-300 border-2 pr-10 font-mono"
              />
              <button
                type="button"
