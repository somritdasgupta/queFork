...
export function ExportDialog({ request, isOpen, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative w-full max-w-3xl mx-4 bg-card shadow-2xl border border-border overflow-hidden"
